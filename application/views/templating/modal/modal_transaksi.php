<div class="col-sm-6 col-md-3 m-t-30">
	<div id="modal_tambah_transaksi" data-keyboard="false" data-backdrop="static" class="modal fade" tabindex="-1"
		role="dialog" aria-labelledby="label_modal_tambah_transaksi" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
							...
							<form action="" method="post" id="form_tambah_data_transaksi">
								...
								<div class="form-group ">
									...
									<select class="form-control" name="nama" id="nama">
										<option value="Pilih Nama Anggota" id="pilih-anggota">Pilih Nama Anggota
										</option>
									</select>
								</div>
								<div class="form-group ">
								...
								<div class="form-group ">
									...
									<input class="form-control" autocomplete="off" type="text" name="nominal"
										id="nominal">
								</div>
								<div class="form-group ">
							...
							<div class="row">
								<div class="col-12">
									...
									<p class="text-muted mb-0 font-14">
										1. Download template file csv terlebih dahulu.
									</p>
									<p class="text-muted mb-0 font-14">
										2. Lengkapi data pada kolom yang sudah tersedia
									</p>
									<p class="text-muted m-b-15 font-14">
										3. Tarik file atau klik area kotak untuk pilih file.
									</p>

									<form action="#" id="form_import_transaksi" enctype="multipart/form-data"
										method="post">
										<div class="input-group mt-2">
											<div class="custom-file">
												<label class="custom-file-label" for="csv-file">Pilih File</label>
												<input type="file" class="custom-file-input" name="nFileUploadTransaksi"
													id="csv-file-transaksi" required accept="text/csv" />
											</div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary waves-effect" id="tombol-keluar"
						data-dismiss="modal">Close</button>
					<button type="button" class="btn btn-primary waves-effect waves-light"
						id="tambah-transaksi">{judul_tombol}</button>
				</div>
			</div>
		</div>
	</div>
